export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <p className="max-w-2xl mx-auto font-Ovo">Full Stack Developer at We Touch Technologies with 2 years of experience in building scalable web applications.</p>
